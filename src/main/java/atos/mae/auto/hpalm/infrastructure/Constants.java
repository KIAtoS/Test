...
private Constants() {}
   ...
   public static final String URL = "https://hpalm.gsissc.myatos.net/qcbin";
//   public static final String HOST = "localhost";
//   public static final String PORT = "8080";

   public static final String USERNAME = "A217281";
   public static final String PASSWORD = "&FRANCEvisas!05";

   public static final String DOMAIN = "FR_NAN_MAEDI";
   public static final String PROJECT = "FRANCE_VISAS";
